...
function UserInfoRegister() {
  ...
  return (
    <center><form onSubmit={onSubmitFunction}>
    <center>
    ...
    <div className="selectContainer"><LocalizationProvider dateAdapter={AdapterDayjs}>
      <DatePicker
        className="select"
    ...
    <div className="textField selectContainer">
      <TextField
        className="select"
        select
